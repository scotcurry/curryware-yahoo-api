...
namespace curryware_kafka_producer_library_tests;

public class ValidateKafkaSettingTest(ITestOutputHelper output)
{
    const string KafkaTopic = "TopicForTests";
    
    [Fact]
    public void KafkaSettingsTest()
    {
        Environment.SetEnvironmentVariable("KAFKA_BOOTSTRAP_SERVER", "localhost:9092");
